...
# 將PDF頁面轉換為圖片的新函數
def convert_pdf_to_page_images(file_path, file_name, database_dir="./database"):
    """
    將PDF文件的每一頁轉換為圖片
...
# 新增幻燈片到圖像的轉換函數
def convert_pptx_to_slide_images(file_path, file_name, database_dir="./database"):
    """
...
def extract_pdf_elements(file_path, file_name, database_dir="./database"):
    """
...
def extract_pptx_elements(path, fname, database_dir="./database"):
    """
